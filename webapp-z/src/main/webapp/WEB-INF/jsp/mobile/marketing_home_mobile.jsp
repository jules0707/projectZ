...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <hr/> <hr/>
 <header>
		<h3>${label.marketing.home.mobile}</h3>
	</header>
	<p>
	...
	<p>Vivamus sagittis lacus vel augue laoreet rutrum fctor. Duis mollis, est non commodo luctus, nisi
	erat pt. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>
	<ul>
		<li>Praesent commodo cursus magna, vel scelerisque nsectetur et.</li>
